...
const menus = [
  { icon: '✨', title: '새 콘텐츠 생성', desc: 'AI로 텍스트 / 이미지 / 영상 생성', href: '/admin/content/new', color: 'var(--color-primary)' },
  { icon: '📋', title: '고객 DB 입력', desc: '업종 / 키워드 / 채널 / KPI 입력', href: '/admin/input', color: 'var(--color-accent)' },
  { icon: '🔍', title: '검수 대기', desc: 'AI 생성 결과 승인 / 반려', href: '/admin/review', color: 'var(--color-warning)' },
  { icon: '👥', title: '리드 관리', desc: '리드 목록 / 상태 관리', href: '/admin/leads', color: '#7C3AED' },
  { icon: '📊', title: '리포트', desc: '채널별 성과 / 월간 리포트', href: '/admin/report', color: 'var(--color-success)' },
  { icon: '📱', title: '채널 현황', desc: 'SNS 채널 상태 / 업로드 현황', href: '/admin/content', color: '#DB2777' },
]
  ...
  return (
    <div className={styles.container}>
      <div className={styles.welcome}>
        ...
        <Link href="/admin/content/new" className={styles.newBtn}>
          + 새 콘텐츠 생성
        </Link>
      </div>
